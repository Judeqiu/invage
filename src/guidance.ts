...
const analysis = (): string =>
  [
    '*Investment analysis (3-axis)*',
    '',
    'Skill: *investment-analysis* · Tool: portfolio analyzer (Yahoo Finance live data)',
    '',
    '*Axes*',
    '1. *Laggards* — your cost > analyst high target (underwater recovery risk)',
    '2. *Overpriced* — price > median target (premium / take-profit zone)',
    '3. *Buy opportunities* — upside to median > ~15%',
    '',
    '*What to say*',
    '• "Analyze my portfolio" / "3-axis analysis"',
    '• "What are my laggards?" / "Any buy opportunities?"',
    '• "Show PE and targets for AAPL, MSFT" (ad-hoc tickers OK)',
    '',
    '*Metrics I use*',
    '• Price vs cost (P/L %), median/mean/high targets, PE / PEG / ROE when available',
    '',
    '*Rules*',
    '• No buy/sell story without tool numbers',
    '• Missing Yahoo data → I say so (no invented quotes)',
    '',
...
const skills = (): string =>
  [
    ...
    '',
    '• *investment-analysis* — 3-axis framework, PE/PEG/ROE, recommendations',
