...
const portfolio = (): string =>
  [
    ...
    '',
    '*Options (calls / puts)*',
    '• US-style: **1 contract = 100 shares** of underlying (set `multiplier=100`)',
    '• `avg_price` = **premium per share**; total premium = avg_price × contracts × multiplier',
    ...
    '• `mark` = current premium/share for MTM (defaults to trade premium at entry; update later)',
    '• Private underlyings OK (e.g. SPACEX) — no Yahoo ticker required; valuation uses `mark`',
    '• Example: "Add short put on SpaceX, 1 contract, strike $90, premium $265/share, expiry 2026-08-07, physical"',
    '  → key `SPACEX-P-90-20260807-S`, premium $26,500, contingent cash obligation $9,000',
    '• Short puts: dashboard shows premium collected + contingent cash obligation (strike × 100 × contracts)',
    '• Short calls: contingent share delivery (contracts × multiplier)',
    '',
    '*Other*',
