...
export const THRESHOLDS = {
  ...
  peAttractive: 20,
  peExpensive: 30,
  forwardPeAttractive: 18,
  forwardPeExpensive: 28,
  roeGood: 0.15,
  roeWeak: 0.05,
  roaGood: 0.05,
  opMarginGood: 0.1,
  ...
  fcfYieldWeak: 0.02,
  evEbitdaAttractive: 12,
  evEbitdaExpensive: 20,
  pbAttractiveFinancials: 1.2,
  pbExpensiveFinancials: 2.5,
  debtToEquityHigh: 200,
  revenueGrowthCollapse: -0.1,
} as const;
