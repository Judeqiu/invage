...
function holdingRows(positions: LivePosition[]): string {
  if (positions.length === 0) {
    return '<tr><td colspan="8" style="text-align:center;color:#8b949e;padding:16px">No positions</td></tr>';
  }
  return positions
    .map(
      (p) => `<tr>
      <td style="padding:6px 10px;border-bottom:1px solid #21262d;font-weight:600">${escapeHtml(p.ticker)}</td>
      <td style="padding:6px 10px;border-bottom:1px solid #21262d">${p.units}</td>
...
<div style="display:flex;gap:12px;margin-bottom:24px;flex-wrap:wrap">
  ...
  <div style="flex:1;min-width:140px;background:#161b22;border:1px solid #30363d;border-radius:8px;padding:16px;text-align:center">
    <div style="color:#8b949e;font-size:12px;margin-bottom:4px">LIVE VALUE</div>
...
<div style="background:#161b22;border:1px solid #30363d;border-radius:8px;padding:16px;margin-bottom:20px">
  ...
  <table style="width:100%;border-collapse:collapse;font-size:13px">
    <tr style="text-align:left;color:#8b949e;font-size:11px">
      ...
      <th style="padding:6px 10px">Avg Cost</th>
